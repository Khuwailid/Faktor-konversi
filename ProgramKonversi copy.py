    ...
    if pilihan == 3:
     ...
     while True:
         ...
         if Volume == 1:
          ...
          mmkubik = 0.000001  * mmkubik
          print("Volume dalam m³=", mmkubik, "m³")
          ...
          print("Volume dalam liter=", liter, "liter")
             ...
             cmkubik = 1000  * mmkubik
             print("Volume dalam cm³=", cmkubik, "cm³")

             mkubik = 1000000  * cmkubik 
             print("Volume dalam m³=", mkubik, "m³")

             inchkubik = 1727.9998   * footkubik 
             print("Volume dalam inch³=", inchkubik, "inch³")

             liter = 28.31684  * footkubik6 
             print("Volume dalam liter=", liter, "liter")  
         elif Volume == 6:
     ...
     while True:
         ...
         if Tekanan == 1:
          ...
          print("Tekanan dalam psi=", psi, "psi")
             ...
             mmHg =133.32199   * Pascal
             print("Tekanan dalam mmHg=", mmHg, "mmHg")

             psi = 6894.75909   * Pascal
             print("Tekanan dalam psi=", psi, "psi")    
         elif Tekanan == 4:
